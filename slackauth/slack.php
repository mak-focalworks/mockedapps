<?php
    if(isset($_GET['code'])){
        ...
        $curl1 = curl_init();
        curl_setopt($curl1, CURLOPT_URL, 'https://slack.com/api/oauth.access?code='.$_GET['code'].'&client_id=112655623728.166099875590&client_secret=8a7c321e7b5d5f53ab544298d9b79c07');
